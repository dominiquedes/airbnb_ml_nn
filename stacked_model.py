...
class StackedRegressor:
    def __init__(self):
        ...
        # Meta-model (will combine predictions from base models)
...
def load_and_preprocess_data():
    ...
    # Convert superhost to numeric first
...
def main():
    ...
    if not os.path.exists('plots_stacked'):
        os.makedirs('plots_stacked')
    
    # Save results
    with open('plots_stacked/results.json', 'w') as f:
        json.dump(results, f, indent=4)
    
    print("\nResults saved in plots_stacked directory")

    # Print feature importance summary with correct pairing of features and importances
